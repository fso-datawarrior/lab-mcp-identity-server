...
- **AD-12: A stranger could clone the repo and try it just by its being public.** Running it required an Okta org, a service app, a seed, and for the full chain a second lab and a tunnel. Closed with a sample environment file, a seed script, and a mock mode; 115 zero-credential tests; break-glass and checklist docs.
